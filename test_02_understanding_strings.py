...
def test_triple_quoted_strings_can_have_both_single_and_double_quotes():
    ...
    assert (tq_str == dq_str) == are_equal
...
-black slash not countable in string
-string slicing creates a new lists
-
...
len
sort
str methods - join, replace, split
mutable & immutables

Note: Python provides several str methods, But None of these change the original object
"""
